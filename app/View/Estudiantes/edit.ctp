  ...
  <div class="col-lg-12">
    <fieldset>
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <input name="data[Estudiante][legajo]" id="legajo" autocomplete="off" class="form-control" type="number" value="<?php echo h($this->request->data['Estudiante']['legajo']) ?>" autofocus required>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <input name="data[Estudiante][nombre]" id="nombre" autocomplete="off" class="form-control" type="text" value="<?php echo h($this->request->data['Estudiante']['nombre']) ?>" required>
          <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
        </div>
      </div>
